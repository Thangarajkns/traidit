										...
										<div class="col-md-12">
											<div class="panel widget">
												...
												<form:form 
									                ...
									                method="POST" 
									                action="${pageContext.request.contextPath}/web/taxeslist.htm" 
														...
														<div style="overflow:scroll;overflow-y:hidden;">		
															<table class="table table-bordered">
																<thead>
																	<tr>
																		<th>Sno</th>
																		<th><a href="#" data-sort-by="socialSecurityNumber" onclick="sortResultsBy(this)">Social Security Number</a></th>
																		<th><a href="#" data-sort-by="firstName" onclick="sortResultsBy(this)">First Name</a></th>
																		<th><a href="#" data-sort-by="MiddleName" onclick="sortResultsBy(this)">Middle Name</a></th>
																		<th><a href="#" data-sort-by="lastName" onclick="sortResultsBy(this)">Last Name</a></th>
																		<th><a href="#" data-sort-by="dateOfBirth" onclick="sortResultsBy(this)">Date Of Birth</a></th>	
																	</tr>
																</thead>
																<tbody>
																	<c:if test="${not empty taxes }">
																		<c:forEach items="${taxes}" var="tax" varStatus="loop">
																		<c:set var="loopCount" value="${loop.index+1}"></c:set>
																			<tr>
																				<td>${i}</td>
																				<td>${tax.socialSecurityNumber}</td>
																				<td>${tax.firstName}</td>
																				<td>${tax.middleName}</td>
																				<td>${tax.lastName}</td>
																				<td><fmt:formatDate value="${tax.dateOfBirth}" pattern="MM/dd/yyyy" /></td>
															...
															<c:if test="${empty taxes }"><td style="text-allign:center;">no taxes found</td></c:if>
														</div>
													</form:form>	
												</div>
