...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/breakpoints.js"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/bootstrap-switch.min.js"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/drilldown.js"></script> 
