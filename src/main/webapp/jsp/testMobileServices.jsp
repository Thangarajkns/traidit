...
<html>
	...
	<body>
		...
		Checking User Password Authentication<input type="button" name="Button88" value="checking user password authentication" onclick="checkinguserpasswordauthentication()"><br>
	</body>
