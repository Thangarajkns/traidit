					...
					<div class="vd_content clearfix">
						...
						<div class="vd_title-section clearfix">
							<div class="vd_panel-header">
								<h1>Commissions</h1>
								<small class="subtitle">To be paid this month</small>
													...
													<div style="overflow:scroll;overflow-y:hidden;">		
															<table class="table table-bordered">
																...
																<c:forEach items="${commissions }" var="commission">
																	<tr>
																		<td>${commission.benificiary.userName }</td>
																		<td>${commission.commissionAmount }</td>
																		<td><fmt:formatDate value="${commission.benificiary.accountExpiryDate }" pattern="dd-MM-yyyy"/></td>
																	</tr>
																</c:forEach>
																</tbody>
															</table>
