	 ...
	 */
		function getdeposittosaveorupdate(){
			$.ajax({
			  ...
			  data: JSON.stringify({depositid:"0",userid:userId,bankname:"vijaya bank",accounttype:"current" ,routingnumber: "bc123",accountnumber: "02"}),
			  contentType: 'application/json',
			  success: function(data) {
				  alert(data);
			  }
		 ...
		 */
			function gettaxtosaveorupdate(){
				$.ajax({
				  ...
				  data: JSON.stringify({taxid:"0",userid:userId,socialsecuritynumber:"kns04",firstname:"sankar" ,middlename: "r",lastname: "sai",dateofbirth:"12/12/1992",termsandconditions:true}),
				  contentType: 'application/json',
				  success: function(data) {
					  alert(data);
				  }
			 ...
			 * Function For checking the user password authentication
			 */
			function checkinguserpasswordauthentication(){
				$.ajax({
				  type: "POST",
				  url: host+"/traidit/passwordauthentication.htm",
				  data: JSON.stringify({userid: "25", password: "admin123"}),
				  contentType: 'application/json',
				  success: function(data) {
					  alert(data);
				  }
