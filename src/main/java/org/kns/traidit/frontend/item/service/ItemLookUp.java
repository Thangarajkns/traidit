...
public class ItemLookUp {
    ...
    */
   private static final String AWS_ACCESS_KEY_ID = "AKIAIBOTZXRZRAWRYPGQ";

   /*
    * Your AWS Secret Key corresponding to the above ID, as taken from the AWS
    * Your Account page.
    */
   private static final String AWS_SECRET_KEY = "iHPYwdad5McW+e4Tt7hLn6bqpOAVTagiS0T8MJpO";
   ...
   public static void main(String[] args) {
        ...
        */
	   System.out.println("hi amazon");
       SignedRequestsHelper helper;
       try {
    	   System.out.println("hi im working");
           helper = SignedRequestsHelper.getInstance(ENDPOINT, AWS_ACCESS_KEY_ID, AWS_SECRET_KEY);
       } catch (Exception e) {
    	   System.out.println("hi im not working");
           e.printStackTrace();
           return;
       }
